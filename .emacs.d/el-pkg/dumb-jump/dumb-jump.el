...
(defcustom dumb-jump-language-file-exts
  '((:language "elisp" :ext "el" :agtype "elisp" :rgtype "elisp")
    ...
    (:language "coq" :ext "coq" :agtype nil :rgtype nil)
    ...
    (:language "systemverilog" :ext "v" :agtype "verilog" :rgtype "verilog")
    (:language "systemverilog" :ext "vh" :agtype "verilog" :rgtype "verilog")
