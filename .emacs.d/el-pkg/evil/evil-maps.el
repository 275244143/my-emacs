...
;(define-key evil-motion-state-map "gd" 'evil-goto-definition);;comment by lixy
...
(define-key evil-motion-state-map "gd" 'evil-search-word-forward);;added by lixu
...
(define-key evil-motion-state-map "\C-q" 'evil-visual-block);;added by lixu
